...
# Load models
model_names = [
    "Linear Regression","RobustRegression","Ridge Regression","Lasso Regression","ElasticNet",
    "Polynomial Regression","SGDRegressor",
    "ANN", "Random Forest Regressor", "SVM", "LGBM", "XGBoost",
    "KNN",  
]
